				...
				<div class="form-subcontrol">
					<div class="form-label form-label-sticky input-label">
						<label>
							...
							<a href="http://blogengine.ru/help/text/" target="_blank" class="nu e2-admin-link">
								<span class="e2-svgi">
									<?= _SVG ('help') ?>
								</span>
							</a>
					...
					<div class="form-element">
						<div id="e2-uploaded-image-prototype" class="e2-uploaded-image" style="display: none">
							<div style="position: relative">
								<a class="e2-uploaded-image-remover nu" href="">
									<span class="e2-svgi">
										<?= _SVG ('remove-pic') ?>
									</span>
								</a>
								<a class="e2-uploaded-image-preview" href="javascript:return(false)">
									<img src="" alt="" />
								</a>
							</div>
						</div>
						<div id="e2-uploaded-images">
							<?php foreach ($content['form-tag']['uploads'] as $image) { ?>
								<div class="e2-uploaded-image">
									<span class="e2-uploaded-image-preview">
										<img src="<?= $image['href'] ?>" alt="<?= $image['original-filename'] ?>" width="<?= $image['width'] ?>" height="<?= $image['height'] ?>" />
									</span>
								</div>
							<?php } ?>
						</div>
						<p id="e2-upload-controls" class="e2-upload-controls admin-links" style="display: none">
							<a href="javascript:" id="e2-upload-button" class="nu">
								<span class="e2-svgi">
									<?= _SVG ('attach') ?>
								</span>
							</a>
							<span id="e2-uploading" style="display: none">
								<?= _SVG ('spin-progress') ?>
							</span>
							<br />
						</p>
						<p class="e2-upload-error" id="e2-upload-error-unsupported-file" style="clear: left; display: none">
							<?= _S ('er--unsupported-file') ?>
						</p>
						<p class="e2-upload-error" id="e2-upload-error-cannot-create-thumbnail" style="clear: left; display: none">
							<?= _S ('er--cannot-create-thumbnail') ?>
						</p>
						<p class="e2-upload-error" id="e2-upload-error-cannot-upload" style="clear: left; display: none">
							<?= _S ('er--cannot-upload') ?>
						</p>
					</div>
				</div>
