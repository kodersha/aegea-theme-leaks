	...
	>
		...
		<div class="form">
			...
			<div class="form-control">
				<div class="form-label input-label">
					<label><?= _S ('ff--blog-description') ?></label>
				</div>
				<div class="form-element">
					<textarea
						...
						<div id="e2-template-selector" style="display: none">
							<?php foreach ($content['form-preferences']['templates'] as $template) { ?>
								...
								<span class="e2-template-name">
									<a class="e2-pseudolink e2-admin-link" onclick="return false">
			...
			<?php if (@$content['form-preferences']['includes-yandex-metrika?']) { ?>
				<div class="form-control">
					<div class="form-label input-label">
						<label><?= _S ('ff--yandex-metrika') ?></label>
					</div>
					<div class="form-element">
						<textarea
							class="width-4 e2-textarea-autosize"
				...
				<div class="form-control">
					<div class="form-label input-label">
						<label><?= _S ('ff--google-analytics') ?></label>
					</div>
					<div class="form-element">
						<textarea
							class="width-4 e2-textarea-autosize"
						...
						>
							<?= $content['form-preferences']['google-analytics'] ?>
						</textarea>
					</div>
				</div>
			<?php } ?>
