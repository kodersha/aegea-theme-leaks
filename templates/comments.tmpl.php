	...
	<div class="content">
						...
						<div class="<?= $comment['spam-suspect?']? 'e2-spam' : '' ?> <?= $comment['visible?']? '' : 'e2-hidden' ?>">
							...
							<div class="e2-comment e2-comment-control-group">
								...
								<div class="e2-comment-meta-area">
									<span class="e2-comment-author" title="<?= _DT ('j {month-g} Y, H:i, {zone}', $comment['time']) ?>">
									...
									<span class="e2-comment-actions admin-links">
										<?php if (array_key_exists ('important-toggle-href', $comment)): ?>
											<a href="<?= $comment['important-toggle-href'] ?>" class="nu e2-important-toggle <?= ($comment['important?']? 'e2-toggle-on' : '') ?>">
												<span class="e2-svgi">
									...
									<p class="time">
										<?= _DT ('j {month-g} Y, H:i', $comment['time']) ?>
									</p>
								</div>
								...
								<div class="e2-comment-content-area">
									<span class="e2-comment-actions-removed admin-links" style="display: none">
										<?php if (array_key_exists ('removed-toggle-href', $comment)): ?>
											<a href="<?= $comment['removed-toggle-href'] ?>" class="nu e2-removed-toggle e2-toggle-on e2-pseudolink">
												<span class="e2-svgi">
													<span class="e2-toggle-state-on">
														<?= _SVG ('replace') ?>
													</span>
								...
								<?php if (array_key_exists ('edit-href', $comment) or array_key_exists ('removed-toggle-href', $comment)): ?>
									<div class="e2-comment-control-area">
										<span class="e2-comment-secondary-controls e2-comment-actions admin-links">
											<?php if ($comment['visible?'] and !$comment['replying?'] and array_key_exists ('reply-href', $comment)): ?>
												<span class="admin-icon">
													<a href="<?= $comment['reply-href'] ?>" class="nu e2-comment-reply">
														<span class="e2-svgi">
											...
											<?php if (array_key_exists ('edit-href', $comment)): ?>
												<span class="admin-icon">
													<a href="<?= $comment['edit-href'] ?>" class="nu">
														<span class="e2-svgi">
															<i class="icon-pen"></i>
														</span>
													</a>
											...
											<?php if (array_key_exists ('removed-toggle-href', $comment)): ?>
												<span class="admin-icon">
													<a href="<?= $comment['removed-toggle-href'] ?>" class="e2-removed-toggle nu">
														<span class="e2-svgi">
															<span class="e2-toggle-state-off">
							...
							<?php if (@$content['form'] != 'form-comment-reply' and $comment['replied?']) { ?>
								<div class="e2-comment e2-comment-control-group e2-reply">
									<div class="e2-comment-meta-area">
										<div>
											<span class="e2-comment-author" title="<?= _DT ('j {month-g} Y, H:i, {zone}', @$comment['reply-time']) ?>">
									...
									<div class="e2-comment-content-area">
										<span class="e2-comment-actions-removed admin-links" style="display: none">
											<?php if (array_key_exists ('removed-reply-toggle-href', $comment)): ?>
												<a href="<?= $comment['removed-reply-toggle-href'] ?>" class="nu e2-removed-toggle e2-toggle-on e2-pseudolink">
													<span class="e2-svgi">
														<span class="e2-toggle-state-on">
															<?= _SVG ('replace') ?>
														</span>
										...
										<div class="e2-comment-control-area">
											<span class="e2-comment-secondary-controls e2-comment-actions admin-links">
												<?php if (array_key_exists ('edit-reply-href', $comment)): ?>
													<span class="admin-icon">
														<a href="<?= $comment['edit-reply-href'] ?>" class="nu">
															<span class="e2-svgi">
																<i class="icon-pen"></i>
															</span>
														</a>
												...
												<?php if (array_key_exists ('removed-reply-toggle-href', $comment)): ?>
													<span class="admin-icon">
														<a href="<?= $comment['removed-reply-toggle-href'] ?>" class="e2-removed-toggle nu">
															<span class="e2-svgi">
																<span class="e2-toggle-state-off">
																	<i class="icon-cross_mark"></i>
																</span>
		...
		<?php if (array_key_exists ('comments-toggle', $content)) { ?>
			<div class="e2-comment-toggle">
				<a class="e2-button" href="<?=$content['comments-toggle']['href']?>">
					<?= $content['comments-toggle']['text'] ?>
				</a>
			</div>
		<?php } ?>
