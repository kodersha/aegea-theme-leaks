        ...
        <?php if (array_key_exists ('thumbs', $note) and (count ($note['thumbs']))) { ?>
            <div class="e2-search-thumb">
                <a href="<?= $note['href'] ?>" class="nu">
                    <?php foreach ($note['thumbs'] as $x) { ?>
                        <img src="<?= $x['href'] ?>" width="<?= $x['width'] ?>" height="<?= $x['height'] ?>" class="e2-search-results-image <?php if ($x['highlighted?']) { ?>e2-search-results-image-highlighed<?php } ?> <?php if ($note['has-highlighted-thumbs?'] and !$x['highlighted?']) { ?>e2-search-results-image-dimmed<?php } ?>" />
                    <?php } ?>
                </a>
            </div>
        <?php } ?>
